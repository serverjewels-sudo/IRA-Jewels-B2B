  ...
  return (
    <div className="p-8 lg:p-12 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* Catalogue Card */}
        <Link href="/portal/catalogue" className="bg-white border border-ira-border p-8 hover:border-ira-teal transition-colors group flex flex-col h-full cursor-pointer">
        ...
        {/* Quotes Card */}
        <Link href="/portal/quotes" className="bg-white border border-ira-border p-8 hover:border-ira-teal transition-colors group flex flex-col h-full cursor-pointer">
          <div className="mb-6 bg-ira-ivory w-12 h-12 flex items-center justify-center rounded-sm">
            <svg className="w-6 h-6 text-ira-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {/* Account Card */}
        <Link href="/portal/account" className="bg-white border border-ira-border p-8 hover:border-ira-teal transition-colors group flex flex-col h-full cursor-pointer">
          <div className="mb-6 bg-ira-ivory w-12 h-12 flex items-center justify-center rounded-sm">
            <svg className="w-6 h-6 text-ira-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <h3 className="font-serif text-2xl text-ira-teal mb-3">Account</h3>
          <p className="text-sm text-ira-muted mb-8 flex-grow">View your account details and manage your password.</p>
        </Link>
      </div>
    </div>
  )
