...
export default function SliceProcess() {
  return (
    <section className="relative h-full flex flex-col items-center max-md:justify-end md:justify-center max-md:py-16 text-center px-6 md:px-12 md:items-end md:text-right">
      ...
      />
      <img 
        src="https://upfqnvazerkervvxeugo.supabase.co/storage/v1/object/public/product-images/final%20image%201%20mobile.jpeg" 
        alt="Process Background Mobile" 
        className="block md:hidden absolute inset-0 w-full h-full object-cover z-0" 
      />
      <div className="block md:hidden absolute inset-0 bg-black/40 z-[5]"></div>
