export default function SlicePartnership() {
  return (
    <section className="h-full bg-ira-gold-beige flex flex-col items-center justify-center text-center px-6 md:px-12">
      <div className="max-w-4xl mx-auto space-y-6 md:space-y-8">
        ...
        <p className="text-ira-muted text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
